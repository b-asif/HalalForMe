...
export const PP_SECTIONS = [
  {
    ...
    body: 'HalalForMe ("we," "our," or "us") is committed to protecting your personal information. This Privacy Policy explains how we collect, use, store, and safeguard your data when you use the HalalForMe mobile application ("App").\n\nBy creating an account or using the App, you agree to the collection and use of your information as described in this Privacy Policy.',
  },
  {
