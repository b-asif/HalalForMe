    ...
    <SafeAreaView style={s.flex}>
      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.introCard}>
          ...
          <Text style={s.introText}>Last updated: August 20, 2026</Text>
          <Text style={[s.introText, { marginTop: 8 }]}>
            Please read these terms carefully before using Rihdal. By using the App you agree to be bound by these Terms of Service.
          </Text>
        </View>
